...
describe('Grave Digger Repository - Unit Tests', ()=>{
  ...
  test('should find grave digger in database', async ()=> {
    ...
    expect(grave_digger.birth_date).toStrictEqual(new Date('2003-07-03 00:00:000'))
  ...
  test('should update gravedigger in database', async()=>{
    ...
    expect(grave_digger.birth_date).toStrictEqual(new Date(graveDiggerUp.birthDate + ' 00:00:000'))
