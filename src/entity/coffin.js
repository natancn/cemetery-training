export class CoffinEntity{
    ...
    constructor({id,material,location,size,location,tomb,tumulus}){
        this.id = id;
    ...
    validator(){
        ...
        if(!this.material || this.material !== 'Carvalho' && this.material !== 'Nogueira' && this.material !== 'Pinho'){
            errors.push(' invalid material')
        }

        if(!this.size || this.size !== 'S' && this.size !== 'M' && this.size !== 'B'){
